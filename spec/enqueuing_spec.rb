...
describe 'enqueueing' do
  ...
  shared_examples 'job fields' do
    it 'is a job instance' do
      expect(subject).to be_a(Arj::TestJob)
    end
  ...
  context '.perform_later' do
    ...
    context 'return value' do
      include_examples 'job fields'
    end
  end

  context 'lookup' do
    subject { Arj::TestJob.last }

    before do
      Arj::TestJob.set(set_options).perform_later(*args, **kwargs)
    end
